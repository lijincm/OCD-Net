...
def train(model: ContinualModel, dataset: ContinualDataset,
    ...
    for t in range(dataset.N_TASKS):
        ...
        #if t > 0:
        #curr_model = model.net
        #torch.save(dict(params=curr_model.state_dict()), osp.join('./pth', 'dercif' + '_' + str(t) + '.pth'))
            #cur_model = model.stable_model
            #torch.save(dict(params=cur_model.state_dict()),osp.join('./pth', 'sta' + '_' + str(t) + '.pth'))
